...
Shader "AxieMixer3D/S_Cel_Standard_Amplify"
{
	Properties
	{
		...
		_master_Color("master_Color", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( PackedVaryings input  ) : SV_Target
			{
				...
				float3 Color = ( _master_Color * ( saturate( lerpBlendMode90 )) ).rgb;
...
Node;AmplifyShaderEditor.ColorNode;94;2208,-768;Inherit;False;Property;_master_Color;master_Color;13;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;92;2346.276,-395.0773;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B1F69B0288353DEA932B4CED16A70F12F242E647